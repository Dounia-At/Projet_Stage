...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ url('affectations/'.$affectation->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group @if($errors->get('quantite')) has-error @endif">
                    ...
                    <input type="number" name="quantite" class="form-control" value="{{ $affectation->quantite }}">
